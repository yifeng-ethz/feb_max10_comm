...
proc elaborate {} {
    ...
    set_interface_property diagnostic ENABLED [expr {$debug_level > 0 ? "true" : "false"}]
}

add_fileset QUARTUS_SYNTH QUARTUS_SYNTH "" ""
set_fileset_property QUARTUS_SYNTH TOP_LEVEL max10_prog_avmm
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file rtl/max10_spi_split.vhd VHDL PATH rtl/max10_spi_split.vhd
add_fileset_file rtl/max10_prog_avmm.vhd VHDL PATH rtl/max10_prog_avmm.vhd TOP_LEVEL_FILE
add_fileset_file max10_prog_avmm.sdc SDC PATH max10_prog_avmm.sdc
...
add_interface_port csr_avmm avs_csr_address address Input CSR_ADDR_W
...
add_interface_port csr_avmm avs_csr_burstcount burstcount Input BURSTCOUNT_W
